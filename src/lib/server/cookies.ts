...
// Refresh cookie OAuth authorize isteğinde de gönderilebilsin diye kökten paylaşılır.
const options = { httpOnly: true, secure: process.env.NODE_ENV === 'production', sameSite: 'lax' as const, path: '/', maxAge: 7 * 24 * 60 * 60 };
